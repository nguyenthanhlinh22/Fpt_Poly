...
function loai_update($ma_loai, $ten_loai) //cập nhật thông tin loại hh đã có trong csdl
{
...
function loai_select_by_id($ma_loai)//truy vấn và trả về thông tin của 1 loại hh dựa trên ma_loai
{
    $sql = "SELECT * FROM loai WHERE ma_loai=?";
    return pdo_query_one($sql, $ma_loai);
}
function loai_exist($ma_loai)//kt loại hh có tồn tại trong csdl hay k
{
