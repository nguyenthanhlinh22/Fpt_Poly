            ...
            <div class="card-body">
                <form action="index.php" method="POST" enctype="multipart/form-data" id="add_hang_hoa">
                    <div class="row">
                        <div class="form-group col-sm-4">
                            ...
                            <select name="ma_loai" class="form-control" id="ma_loai">
                                ...
                                foreach ($loai_hang as $loai_hang) {  //lặp qua các ptu trong mảng $loai_hang
                                    ...
                                    echo '<option value="' . $ma_loai . '">' . $ten_loai . '</option>'; //hiển thị mỗi ptu dưới dạng 1 tuỳ chọn (option)
                                }
                        ...
                        <div class="form-group col-sm-4">
                            <label for="ten_hh" class="form-label">Tên hàng hóa</label>    <!--tạo nhãn label-->
                            <input type="text" name="ten_hh" id="ten_hh" class="form-control">   <!--nhập tên dạng vb-->
                        </div>
                        <div class="form-group col-sm-4">
                            <label for="ma_hh" class="form-label">Mã hàng hóa</label>
                            <input type="text" name="ma_hh" id="ma_hh" readonly class="form-control"
                                value="auto number"> <!--gtri hiển thị k cho phép ng dùng thay đổi-->
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group col-sm-4">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-sm-4">
                            <?php $today = date_format(date_create(), 'Y-m-d'); ?> <!--tạo và gán gtr của biến $today ngày hiện tại-->
                    ...
                    <div class="mb-3 text-center">
                        ...
                        <input type="submit" name="btn_insert" value="Thêm mới" class="btn btn-primary mr-3"> <!--gán css cho nút-->
