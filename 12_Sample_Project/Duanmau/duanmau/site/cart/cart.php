...
<div class="container">
    ...
    <?php
    if (isset($_SESSION['cart'])) { //Kiểm tra nếu tồn tại giỏ hàng trong session ($_SESSION['cart'])
    ?>
    ...
    <div class="row m-1 pb-5">
        <table class="table table-responsive-md">
            ...
            <tbody class="text-center" id="giohang">
                ...
                <?php foreach ($_SESSION['cart'] as $index => $item) : ?> <!--Lặp qua từng sản phẩm trong giỏ hàng và hiển thị -->
                <tr>
                    <td><?= $index ?></td>
                    <td><?= $item['ten_hh'] ?></td><!-- Hiển thị tên sản phẩm -->
            ...
            <tfoot id="tongdonhang">
                ...
                <tr class="text-right">
                    <th colspan="7">
                         <!-- Nút thanh toán và nút xóa all sp khỏi giỏ hàng -->
