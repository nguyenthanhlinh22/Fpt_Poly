         ...
         <div class="col-md-12">
             <div class="owl-carousel">
                 ...
                 <?php foreach ($hh_cung_loai as $hh_cl) :
                        ...
                        if ($don_gia > 0) {//kt xem giá gốc của sp có lớn hơn 0 hay k. Nếu có, thì tỷ lệ giảm giá sẽ được tính toán.
                            $p_d_hh_cl = number_format($hh_cl['giam_gia'] / $hh_cl['don_gia'] * 100);
                        } else {
                            $p_d_hh_cl = 0;//Nếu giá gốc của sp là 0, thì tỷ lệ giảm giá sẽ được đặt thành 0.
                        }
                     ...
                     <div class="card-body p-0 pt-3">
                         ...
                         <div class="product-price">
                             <div class="col d-flex justify-content-center align-items-center">
                                 <del class="d-block fz-14"><?= number_format($hh_cl['don_gia'], 0, ',') ?>đ</del><!--hiển thị giá gốc và giá giảm giá của sản phẩm, tương ứng.-->
                                 <!--Hàm number_format() được sử dụng để định dạng giá thành chuỗi với hai chữ số thập phân và dấu phẩy làm dấu phân cách.-->
